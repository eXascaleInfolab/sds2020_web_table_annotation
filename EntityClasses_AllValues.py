...
def Multiprocess_Limaye():
    ...
    with open('data/LimayeTypes_allcols.pickle', 'wb') as handle:
        pickle.dump(InstanceOfDict, handle)
    #save dictionary of Levenshtein code to pickle file
    with open('data/LimayeLevenshtein_allcols.pickle', 'wb') as handle:
...
def Multiprocess_T2D():
    ...
    #save dictionary of label:instanceof to pickle file
    with open('data/T2DTypes_allcols.pickle', 'wb') as handle:
        pickle.dump(InstanceOfDict, handle)
    #save dictionary of Levenshtein code to pickle file
    with open('data/T2DLevenshtein_allcols.pickle', 'wb') as handle:
        pickle.dump(LevenshteinDict, handle)
