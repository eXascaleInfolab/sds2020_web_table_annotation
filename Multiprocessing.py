...
# List8_1 =  ['11599512_1_280388135214354946.csv', '69881946_0_1105130426898457358.csv', '6869358_0_1379459120563510331.csv', '38732532_0_1420803645394505878.csv', '33401079_0_9127583903019856402.csv', '29021592_4_4348860179678308511.csv']#
# List8_2 =  ['29414811_6_8221428333921653560.csv', '11688006_0_8123036130090004213.csv', '13719111_1_5719401842463579519.csv', '26270372_1_3774607938887520564.csv', '57938705_0_8737506792349461963.csv', '60319454_0_3938426910282115527.csv']
# List8_3 =  ['19272019_0_1508498249156534553.csv', '35188621_0_6058553107571275232.csv', '13395751_3_369722706637560735.csv','78005071_0_8643954006825971723.csv'] #16'
...
# List12_1 = ['21585935_0_294037497010176843.csv', '66009064_0_9148652238372261251.csv', '45073662_0_3179937335063201739.csv', '28086084_0_3127660530989916727.csv', '53822652_0_5767892317858575530.csv', '64734047_0_5880705307495695536.csv']
# List12_2 = ['21337553_0_8832378999628437599.csv', '63450419_0_8012592961815711786.csv', '92896255_0_4593968708343548527.csv', '18422942_0_3659164506677528063.csv', '46671561_0_6122315295162029872.csv', '93078729_0_1451251196788678526.csv']
# List12_3 = ['55238374_0_3379409961751009152.csv', '80184932_0_4240003884724905487.csv', '41839679_0_3009344178474568371.csv'] #15
...
# TableList = [List8_1,List8_2,List8_3, List12_1,List12_2,List12_3]

TableList = [List1, List2, List3, List4, List5, List6, List7, List8, List9, List10, List11, List12, List13, List14, List15]
#with header test
# List1 = ['11599512_1_280388135214354946.csv']
#without header test
# List1 = ['13719111_1_5719401842463579519.csv']    
# List1 = ['36039980_4_4283009829602711082.csv']
# TableList = [List1]
...
if __name__ == '__main__':
     ...
     pool.map(Hybrid.RunHybrid, TableList)
     pool.close()
     print('That took {} seconds'.format(time.time() - starttime))

#calculate the precision and recall from here. 
#sum up all TP and .. in here and send to Precision... calculation function
...
# # --> recursion problem
#List1 = ['file394725_0_cols1_rows24.csv']
# List1 = ['file51833_0_cols1_rows68.csv']
#TableList = [List1]
...
#    starttime = time.time()
#    pool = multiprocessing.Pool()
#    pool.map(Hybrid_Limaye.RunHybrid, TableList)
#    pool.close()
#    print('That took {} seconds'.format(time.time() - starttime))
...
# import Hybrid_Wikipedia


# f = open('data/Wikipedia/Wikipedia_Table_Names.txt', 'r')
# x = f.read().splitlines()
...
# List1 = ['Tattoo_(Hunter_Hayes_song)#2.csv']
# TableList = [List1]
...
#     starttime = time.time()
#     pool = multiprocessing.Pool()
#     pool.map(Hybrid_Wikipedia.RunHybrid, TableList)
#     pool.close()
#     print('That took {} seconds'.format(time.time() - starttime))
